%{?scl:%scl_package perl-Parse-RecDescent}
%{!?scl:%global pkg_name %{name}}

Name:           %{?scl_prefix}perl-Parse-RecDescent
Version:        1.967009
Release:        8.sc1%{?dist}
...
BuildRequires:  %{?scl_prefix}perl(Text::Balanced) >= 1.95
# Tests:
...
Requires:       %{?scl_prefix}perl(Text::Balanced) >= 1.95
...
%changelog
* Fri Nov 22 2013 Jitka Plesnikova <jplesnik@redhat.com> - 1.967009-8
- Rebuilt for SCL
